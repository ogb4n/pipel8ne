...
export default function GitOnboardingModal() {
  ...
  const hasAnyProvider = oauthConfig.github.enabled || oauthConfig.gitlab.enabled;
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="px-8 pt-8 pb-4 text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 max-w-sm mx-auto">
            Liez votre compte GitHub ou GitLab pour importer vos dépôts et créer des pipelines
            CI/CD.
          </p>
        </div>
        ...
        <div className="px-8 pb-6 space-y-3">
          {oauthConfig.github.enabled && (
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors group"
            >
              <svg
                width="20"
                height="20"
              ...
              <span className="text-sm font-medium text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">
