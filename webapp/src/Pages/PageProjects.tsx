    ...
    <>
              ...
              {(
                [
                  { label: "Nom", value: newName, setter: setNewName, placeholder: "Mon Pipeline" },
                  {
                    ...
                    value: newPath,
                    setter: setNewPath,
                    placeholder: "/pipelines/mon-pipeline",
                  },
                  {
                    label: "Provider",
                    value: newProvider,
                    setter: setNewProvider,
                    placeholder: "github",
                  },
                ] as {
                  label: string;
      ...
      <div className="max-w-5xl mx-auto px-5 pb-16">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 mt-2">
              Credentials
            </h2>
            <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            {credentials.map((c) => (
              ...
              >
                {/* Provider badge */}
                <span
                  className={`shrink-0 text-[10px] font-bold px-1.5 py-0.5 rounded ${PROVIDER_COLORS[c.provider] ?? "bg-zinc-100 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-300"}`}
                >
                ...
                <button
                  onClick={() => {
                    void handleDeleteCredential(c.id);
                  }}
